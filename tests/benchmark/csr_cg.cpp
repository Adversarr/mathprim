...
static void work(benchmark::State &state) {
  ...
  iterative_solver::cg<float, device::cpu, linear_op, blas_impl> cg{linear_op{mat}};
...
BENCHMARK_TEMPLATE(work, blas::cpu_handmade<float>)->Arg(1000)->Arg(2000)->Arg(4000)->Arg(8000);
BENCHMARK_TEMPLATE(work, blas::cpu_blas<float>)->Arg(1000)->Arg(2000)->Arg(4000)->Arg(8000);
BENCHMARK_TEMPLATE(work, blas::cpu_eigen<float>)->Arg(1000)->Arg(2000)->Arg(4000)->Arg(8000);
BENCHMARK(work_eigen_naive)->Arg(1000)->Arg(2000)->Arg(4000)->Arg(8000);
